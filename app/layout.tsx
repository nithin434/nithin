...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: 'Nithin Jambula Portfolio',
    title: 'Nithin Jambula - ML Engineer | AI Specialist | Computer Vision Expert',
    description: 'Machine Learning Engineer specializing in Deep Learning, Computer Vision, Autonomous Systems, LLM Applications, and Neuro-Symbolic AI at VIT-AP University',
    images: [
      {
        url: '/og-image.jpg',
        width: 1200,
      ...
      },
      {
        ...
        width: 800,
        height: 600,
        alt: 'Nithin Jambula Profile Photo',
      }
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Nithin Jambula - ML Engineer | AI Specialist',
    description: 'Machine Learning Engineer specializing in Deep Learning, Computer Vision, and AI Applications. Building next-gen AI systems at VIT-AP.',
    images: ['/og-image.jpg'],
  },
  alternates: {
